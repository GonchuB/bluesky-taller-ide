 ...
 */
public class CreadorInstruccionSumarPF implements CreadorInstruccion {
    @Override
    public Instruccion factoryMethod(String posMemoria, String lineaCodigoHexa, String comentario) {
        ...
        Instruccion instruccion = new InstruccionSumarPF(registroFuente1,registroFuente2,registroDestino);
