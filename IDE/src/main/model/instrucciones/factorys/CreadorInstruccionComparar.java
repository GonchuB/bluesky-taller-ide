...
import main.model.instrucciones.tipos.InstruccionComparar;
import main.model.instrucciones.tipos.InstruccionSumarA2;

/**
 * Created by Juan-Asus on 21/03/2014.
 */
public class CreadorInstruccionComparar implements CreadorInstruccion {
    ...
    public Instruccion factoryMethod(String posMemoria, String lineaCodigoHexa, String comentario) {
        ...
        Instruccion instruccion = new InstruccionComparar(registroFuente1,registroFuente2,registroDestino);
