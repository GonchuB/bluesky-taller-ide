...
public final class BitVector extends Number implements Cloneable, Iterable<Boolean>, Comparable<BitVector> {
	...
	//returns a new apis.bitvector that is backed by the same data as this one
	//equivalent to clone
	...
	//returns a new mutable apis.bitvector that is backed by the same data as this one
	...
	//returns a new immutable apis.bitvector that is backed by the same data as this one
